                            ...
                            @forelse($laporans as $item)
                                <tr class="hover:bg-blue-50 transition">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-center">
                                        @if($item->file_pdf)
                                            <a href="{{ asset('arsip/'.$item->file_pdf) }}" target="_blank" class="inline-flex items-center text-red-600 hover:text-red-800 font-bold text-sm bg-red-50 hover:bg-red-100 px-3 py-1 rounded transition">
