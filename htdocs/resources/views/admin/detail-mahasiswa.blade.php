                    ...
                    <div class="flex flex-col md:flex-row justify-between items-start gap-6">
                        ...
                        <div class="bg-white/10 p-5 rounded-xl backdrop-blur-sm w-full md:w-auto border border-white/20">
                            ...
                            @if($laporanMingguan->file_pdf)
                                <a href="{{ asset('arsip/'.$laporanMingguan->file_pdf) }}" target="_blank" class="block w-full text-center bg-white text-blue-800 hover:bg-blue-50 font-bold px-4 py-2 rounded shadow mb-3 transition">
                                    📄 Buka File PDF
                                </a>
                        ...
                        <tbody class="divide-y divide-gray-200">
                            @forelse($magang->laporanMingguans()->orderBy('minggu_ke', 'desc')->get() as $laporan)
                                <tr class="hover:bg-blue-50">
                                    ...
                                    <td class="px-6 py-4">
                                        @if($laporan->file_pdf)
                                            <a href="{{ asset('arsip/'.$laporan->file_pdf) }}" target="_blank" class="text-blue-600 hover:underline font-bold flex items-center">
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-4 py-2 text-center">
                                            @if($log->foto_kegiatan)
                                                <a href="{{ asset('arsip/'.$log->foto_kegiatan) }}" target="_blank" class="text-blue-600 text-xs font-bold hover:underline">Lihat</a>
                                            @else - @endif
                                        </td>
                                    </tr>
                                @empty
                            ...
                            <tbody class="divide-y">
                                @forelse($presences as $p)
                                    <tr>
                                        ...
                                        <td class="px-4 py-2 text-center">
                                            {{-- PERBAIKAN UTAMA: Cek Jam Masuk ATAU Text Hadir (Case Insensitive) --}}
                                            @if(!empty($p->jam_masuk) || strtolower($p->status) == 'hadir') 
