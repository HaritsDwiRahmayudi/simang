                        ...
                        <div>
                            ...
                            <div class="bg-gray-50 p-6 rounded-lg border border-gray-200 text-center mt-4 hover:bg-gray-100 transition">
                                ...
                                @if($magang->surat_balasan)
                                    {{-- JALUR ARSIP: Mengubah 'storage' menjadi 'arsip' agar tembus blokir --}}
                                    <a href="{{ asset('arsip/' . $magang->surat_balasan) }}" target="_blank" class="inline-flex items-center px-5 py-2.5 bg-red-600 hover:bg-red-700 text-white font-bold rounded-lg shadow hover:shadow-lg transition transform hover:-translate-y-0.5">
