...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-bold text-2xl text-blue-900 leading-tight">
            <?php echo e(__('Verifikasi Pendaftaran')); ?>
        ...
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-xl border border-gray-200">
                ...
                <div class="bg-gradient-to-r from-blue-900 to-blue-700 px-8 py-5 flex justify-between items-center">
                    ...
                    <span class="bg-yellow-400 text-blue-900 text-xs font-bold px-3 py-1 rounded shadow uppercase tracking-wide">Status: <?php echo e(ucfirst($magang->status)); ?></span>
                </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="space-y-5">
                            <div>
                                ...
                                <p class="text-xl font-bold text-gray-800"><?php echo e($magang->user->name); ?></p>
                            </div>
                            <div>
                                <p class="text-xs text-gray-400 uppercase font-bold">Nomor Induk Mahasiswa (NIM)</p>
                                <p class="text-lg font-medium text-gray-700 font-mono bg-gray-50 inline-block px-2 py-1 rounded"><?php echo e($magang->nim); ?></p>
                            </div>
                            <div>
                                <p class="text-xs text-gray-400 uppercase font-bold">Asal Universitas</p>
                                <p class="text-lg font-medium text-gray-700"><?php echo e($magang->universitas); ?></p>
                            </div>
                            <div>
                                <p class="text-xs text-gray-400 uppercase font-bold">Jurusan</p>
                                <p class="text-lg font-medium text-gray-700"><?php echo e($magang->jurusan); ?></p>
                            </div>
                            <div class="grid grid-cols-2 gap-4 bg-blue-50 p-4 rounded-lg">
                                <div>
                                    ...
                                    <p class="font-bold text-blue-800"><?php echo e(\Carbon\Carbon::parse($magang->tanggal_mulai)->format('d M Y')); ?></p>
                                </div>
                                <div>
                                    <p class="text-xs text-blue-400 uppercase font-bold">Selesai Magang</p>
                                    <p class="font-bold text-blue-800"><?php echo e(\Carbon\Carbon::parse($magang->tanggal_selesai)->format('d M Y')); ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="space-y-6 flex flex-col h-full">
                        <div>
                            ...
                            <div class="bg-gray-50 p-6 rounded-lg border border-gray-200 text-center mt-4 hover:bg-gray-100 transition">
                                ...
                                <?php if($magang->surat_balasan): ?>
                                    
                                    <a href="<?php echo e(asset('arsip/' . $magang->surat_balasan)); ?>" target="_blank" class="inline-flex items-center px-5 py-2.5 bg-red-600 hover:bg-red-700 text-white font-bold rounded-lg shadow hover:shadow-lg transition transform hover:-translate-y-0.5">
                        ...
                        <div class="mt-auto pt-6 border-t border-gray-200">
                            ...
                            <div class="flex gap-4">
                                <form action="<?php echo e(route('magang.reject', $magang->id)); ?>" method="POST" class="w-1/2">
                                ...
                                <form action="<?php echo e(route('magang.approve', $magang->id)); ?>" method="POST" class="w-1/2">
                                    <?php echo csrf_field(); ?> <?php echo method_field('PATCH'); ?>
...
<?php endif; ?><?php /**PATH /home/vol3_6/infinityfree.com/if0_40994811/htdocs/resources/views/admin/show.blade.php ENDPATH**/ ?>