...
<body class="antialiased bg-gray-50 text-gray-800 font-sans">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16 items-center">
                <a href="<?php echo e(url('/')); ?>" class="flex-shrink-0 flex items-center">
                    <img src="<?php echo e(asset('images/logo ikpp.png')); ?>" alt="Logo IKPP" class="h-10 w-auto mr-6">
                    <img src="<?php echo e(asset('images/logo simang.png')); ?>" alt="Logo Simang" class="h-10 w-auto -mr-2">
                ...
                <div class="hidden sm:ml-6 sm:flex sm:items-center space-x-6">
                    <a href="<?php echo e(url('/')); ?>" class="text-gray-600 hover:text-blue-900 font-medium transition">Beranda</a>
                    <a href="<?php echo e(route('about')); ?>" class="text-blue-900 font-bold border-b-2 border-blue-900 transition">Tentang Kami</a>
                    <?php if(Route::has('login')): ?>
                        <?php if(auth()->guard()->check()): ?>
                            <a href="<?php echo e(url('/dashboard')); ?>" class="text-gray-700 hover:text-blue-900 px-3 py-2 rounded-md text-sm font-semibold border border-gray-300 hover:border-blue-900 transition">Dashboard</a>
                        <?php else: ?>
                            <a href="<?php echo e(route('login')); ?>" class="text-gray-700 hover:text-blue-900 px-3 py-2 rounded-md text-sm font-semibold transition">Login</a>
                        <?php endif; ?>
                    <?php endif; ?>
                </div>
            </div>
        ...
        <div class="container mx-auto px-4">
            <div class="flex flex-col md:flex-row items-center gap-12">
                <div class="w-full md:w-1/2">
                    <img src="<?php echo e(asset('images/ikpp.jpg')); ?>" alt="Pabrik IKPP" class="rounded-xl shadow-2xl hover:scale-[1.02] transition duration-500 w-full object-cover h-96">
                </div>
                <div class="w-full md:w-1/2">
    ...
    <footer class="bg-gray-800 text-gray-300 py-8">
        <div class="container mx-auto px-4 text-center">
            ...
            <p class="text-sm">&copy; <?php echo e(date('Y')); ?> SIMANG IKPP. All rights reserved.</p>
        </div>
    </footer>

</body>
</html><?php /**PATH /home/vol3_6/infinityfree.com/if0_40994811/htdocs/resources/views/about.blade.php ENDPATH**/ ?>