        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-gradient-to-r from-blue-800 to-blue-600 rounded-2xl shadow-xl mb-8 text-white overflow-hidden relative">
                ...
                <div class="p-8 relative z-10 flex flex-col md:flex-row justify-between items-center">
                    <div>
                        <h3 class="text-3xl font-extrabold mb-2 tracking-tight">Halo, <?php echo e(Auth::user()->name); ?>! 👋</h3>
                    ...
                    <div class="mt-6 md:mt-0 text-right bg-white/10 p-4 rounded-lg backdrop-blur-sm border border-white/20">
                        ...
                        <p class="text-2xl font-bold"><?php echo e(\Carbon\Carbon::now()->translatedFormat('l, d F Y')); ?></p>
                    </div>
                </div>
            </div>
            ...
            <?php if(!$magang): ?>
                ...
                <div class="bg-white border-l-8 border-yellow-400 p-8 shadow-lg rounded-r-xl flex flex-col md:flex-row items-center gap-6 animate-fade-in-up">
                    ...
                    <a href="<?php echo e(route('magang.create')); ?>" class="bg-yellow-500 hover:bg-yellow-600 text-white font-bold py-3 px-8 rounded-xl shadow-lg transition transform hover:-translate-y-1 text-lg">
                        Isi Formulir &rarr;
                    </a>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div class="md:col-span-1 space-y-6">
                        <div class="bg-white p-6 rounded-2xl shadow-lg h-full border border-gray-100 relative overflow-hidden">
                            ...
                            <?php elseif($magang->status == 'approved'): ?>
                                ...
                                <div class="mt-6 space-y-4">
                                    <div class="group">
                                        ...
                                        <p class="font-semibold text-gray-800"><?php echo e($magang->universitas); ?></p>
                                    </div>
                                    <div class="group">
                                        <span class="text-xs text-gray-400 font-bold uppercase">Jurusan</span>
                                        <p class="font-semibold text-gray-800"><?php echo e($magang->jurusan); ?></p>
                                    </div>
                                    <div class="bg-blue-50 p-3 rounded-lg border border-blue-100">
                                        ...
                                        <span class="font-bold text-blue-700 text-sm">
                                            <?php echo e(\Carbon\Carbon::parse($magang->tanggal_mulai)->format('d M Y')); ?> s/d 
                                            <?php echo e(\Carbon\Carbon::parse($magang->tanggal_selesai)->format('d M Y')); ?>

                                        </span>
                                    </div>
                                </div>

                            <?php elseif($magang->status == 'rejected'): ?>
                    ...
                    <div class="md:col-span-2 grid grid-cols-1 gap-6">
                        ...
                        <div class="bg-white rounded-2xl shadow-md overflow-hidden hover:shadow-2xl transition duration-300 border border-gray-100 group relative">
                            ...
                            <div class="p-8 flex flex-col md:flex-row items-center gap-8">
                                ...
                                <div class="flex-1 text-center md:text-left">
                                    ...
                                    <a href="<?php echo e(route('laporan.index')); ?>" class="inline-flex items-center justify-center w-full md:w-auto bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-3 px-8 rounded-xl transition shadow-lg hover:shadow-indigo-500/30 transform hover:-translate-y-0.5">
                        ...
                        <div class="bg-white rounded-2xl shadow-md overflow-hidden hover:shadow-xl transition duration-300 border border-gray-100 p-8">
                            ...
                            <form action="<?php echo e(route('laporan.cetak')); ?>" method="GET" target="_blank" class="bg-gray-50 p-6 rounded-xl border border-gray-200">
...
<?php endif; ?><?php /**PATH /home/vol3_6/infinityfree.com/if0_40994811/htdocs/resources/views/dashboard.blade.php ENDPATH**/ ?>