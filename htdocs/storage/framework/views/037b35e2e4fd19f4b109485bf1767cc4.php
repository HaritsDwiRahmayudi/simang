        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16 items-center">
                ...
                <div class="flex-shrink-0 flex items-center gap-2 overflow-hidden">
                    ...
                    <img src="<?php echo e(asset('images/logo ikpp.png')); ?>" alt="Logo IKPP" class="h-8 md:h-10 w-auto">
                    
                    <img src="<?php echo e(asset('images/logo simang.png')); ?>" alt="Logo Simang" class="h-8 md:h-10 w-auto">
                    
                    <span class="hidden md:block font-bold text-xl tracking-tight text-blue-900 ml-2">SIMANG IKPP</span>
                </div>

                <div class="hidden md:flex md:items-center space-x-4">
                    <a href="<?php echo e(route('about')); ?>" class="text-gray-700 hover:text-blue-900 px-3 py-2 rounded-md text-sm font-bold transition border-b-2 border-transparent hover:border-blue-900">
                        Tentang Kami
                    </a>
                    <?php if(Route::has('login')): ?>
                        <?php if(auth()->guard()->check()): ?>
                            <a href="<?php echo e(Auth::user()->role == 'admin' ? route('admin.dashboard') : route('dashboard')); ?>" class="text-blue-900 font-bold px-3 py-2">
                                Dashboard
                            </a>
                        <?php else: ?>
                            <a href="<?php echo e(route('login')); ?>" class="text-gray-700 hover:text-blue-900 px-3 py-2 font-semibold">Masuk</a>
                            <a href="<?php echo e(route('register')); ?>" class="bg-blue-900 hover:bg-blue-800 text-white px-4 py-2 rounded-md text-sm font-semibold shadow-md">Daftar</a>
                        <?php endif; ?>
                    <?php endif; ?>
                </div>
            ...
            <div class="items-center flex flex-wrap">
                <div class="w-full lg:w-8/12 px-4 ml-auto mr-auto text-center">
                    ...
                    <div class="mt-10 flex flex-col sm:flex-row justify-center gap-4 px-4 w-full">
                        <?php if(auth()->guard()->check()): ?>
                            <a href="<?php echo e(Auth::user()->role === 'admin' ? route('admin.dashboard') : route('dashboard')); ?>" class="w-full sm:w-auto bg-white text-blue-900 font-bold px-8 py-4 rounded shadow-lg hover:bg-gray-100 transition duration-300 text-center">
                                Buka Dashboard
                            </a>
                        <?php else: ?>
                            <a href="<?php echo e(route('register')); ?>" class="w-full sm:w-auto bg-blue-600 text-white font-bold px-8 py-4 rounded shadow-lg hover:bg-blue-500 transition duration-300 text-center">
                                Daftar Sekarang
                            </a>
                            <a href="<?php echo e(route('login')); ?>" class="w-full sm:w-auto bg-transparent border-2 border-white text-white font-bold px-8 py-4 rounded shadow-lg hover:bg-white hover:text-blue-900 transition duration-300 text-center">
                                Login Masuk
                            </a>
                        <?php endif; ?>
                    </div>
    ...
    <footer class="bg-gray-200 py-6 mt-10">
        <div class="container mx-auto px-4 text-center">
            <div class="text-sm text-gray-600 font-semibold">
                Copyright © <?php echo e(date('Y')); ?> SIMANG - PT Indah Kiat Pulp & Paper Tbk.
            </div>
        </div>
    </footer>

</body>
</html><?php /**PATH /home/vol3_6/infinityfree.com/if0_40994811/htdocs/resources/views/welcome.blade.php ENDPATH**/ ?>