...
use App\Models\Magang; // JANGAN LUPA INI DITAMBAHKAN BANG
...
class LogbookController extends Controller
{
    ...
    public function index()
    {
        ...
        if (!$magang || $magang->status != 'approved') {
            return redirect()->route('dashboard')->with('error', 'Akses ditolak! Akun magang belum disetujui, Anda tidak bisa mengakses Logbook.');
        }
        // ------------------------
